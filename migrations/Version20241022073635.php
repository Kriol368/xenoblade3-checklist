...
final class Version20241022073635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_gauntlet_emblem (user_id INT NOT NULL, gauntlet_emblem_id INT NOT NULL, checked INT NOT NULL, INDEX IDX_C7F99EC1A76ED395 (user_id), INDEX IDX_C7F99EC171CB3257 (gauntlet_emblem_id), PRIMARY KEY(user_id, gauntlet_emblem_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
