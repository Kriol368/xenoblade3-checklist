...
final class Version20241022065127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quest (id INT AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, checked INT DEFAULT NULL, summary VARCHAR(255) DEFAULT NULL, giver VARCHAR(255) DEFAULT NULL, prerequisites VARCHAR(255) DEFAULT NULL, rewards VARCHAR(255) DEFAULT NULL, chapter VARCHAR(255) DEFAULT NULL, INDEX IDX_4317F81798260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
