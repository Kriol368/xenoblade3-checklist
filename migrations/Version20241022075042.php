...
final class Version20241022075042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_gem (user_id INT NOT NULL, gem_id INT NOT NULL, checked INT NOT NULL, INDEX IDX_7246E73BA76ED395 (user_id), INDEX IDX_7246E73BA5AD5580 (gem_id), PRIMARY KEY(user_id, gem_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
