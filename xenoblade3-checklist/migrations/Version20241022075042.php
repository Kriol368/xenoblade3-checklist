...
final class Version20241022075042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_landmark_location (user_id INT NOT NULL, landmark_location_id INT NOT NULL, `check` TINYINT(1) NOT NULL, INDEX IDX_992E628CA76ED395 (user_id), INDEX IDX_992E628CBB52F0D8 (landmark_location_id), PRIMARY KEY(user_id, landmark_location_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_soul_tree (user_id INT NOT NULL, soul_tree_id INT NOT NULL, `check` TINYINT(1) NOT NULL, INDEX IDX_CB533D3AA76ED395 (user_id), INDEX IDX_CB533D3A57FB914F (soul_tree_id), PRIMARY KEY(user_id, soul_tree_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
